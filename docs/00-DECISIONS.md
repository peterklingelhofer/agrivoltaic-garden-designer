...
- **Doc 03 section 3.2 backtracking formula is wrong.** It is written
...
is a real check. See `docs/07-electrical-grid.md`.
...
3. Remaining base temperatures and DLI values traceable to trackgdd.com, hydroponics blogs and
   ...
   defensible, but doc 04's 0 C lower bound is unsupported.

## 8. Compliance overlays

**REVISED after primary-source verification. Nothing here is a compliance CHECK. Everything is
an ESTIMATE.** See `docs/VERIFICATION.md` for the evidence trail.
...
**2026-09-08.** Two defects, reported together by an owner who ran the feature: they could not
...
**2026-09-08.** Vitest ran this suite for the life of the project and was replaced in a day. The
...
not checkable, because the history was flattened on 2026-09-08. The rule it argued for is kept and
...
questions place, and a ten-year-old who asked for tomatoes was offered hops and sorrel.
...
**2026-09-11.** Two educators, walking the one-column build in a real Chromium, lowered the
panels from 3.4 m to 1.5 m and watched the panels drop in the 3D view while the DLI map, every
per-bed figure and the plant cards stayed frozen. The lead reproduced it with
...
**2026-09-11.** The master gardener's walkthrough, on the garden itself. A hand reaching for the
...
Both reviewers asked for the same thing: "you don't move the camera at all, but you drag stuff".
...
**2026-09-18.** The share of rain a bed loses to the panels and the water the drip lines bring it
...
cell so no water is lost to the grid. Cost: a night, two subagents and twenty tests.

**Amended the next morning, 2026-09-19, then again after an independent audit: the rain sized by
the hour, three thirds of the ground's rain, the drip's whole fall, and the NSRDB's 2 m wind.** A
second pass over the sources found the model short of them in four places, and a three-reviewer
audit of that pass (each reviewer working alone against the papers, then a second round on the four
points they split on) corrected two of the four and confirmed the rest.
...
distances, and Lacy's 4.5 m/s for the rain's own mean fall speed. Cost: a morning, two subagents,
three reviewers over two rounds, 37 tests in the rain file.
