...
This is a different question from `docs/VERIFICATION.md`, which resolves specific claims and
citations across the doc corpus (compliance thresholds, physics constants, a few contested
numbers). This file answers a narrower question a Rutgers agrivoltaics reviewer asked directly:
