...
- **Caveat:** MISMATCH: doc 02 dates this 2022 and gives the title 'Agrivoltaics in Japan: a legal framework analysis'. Crossref records issue year 2024 and the short title 'Agrivoltaics in Japan'.
...
- **Caveat:** Single-site, small-plot. It is the only English-language Japanese solar-sharing crop study located with a verifiable DOI, which is itself evidence for thin-evidence area 10 in doc 02. Doc 05 cites 'Nagashima 2015/2020' and an 'AIP Conf. Proc. 2361(1):030002 2021' that could not be resolved.
...
- **Caveat:** Crossref records online publication in 2023; volume 8 is the 2024 issue year. Doc 03's 2024 is the issue year and is acceptable.
...
- **Caveat:** Doc 02 lists this as 'Jacovides, C.P. et al. (2003)' with no DOI; the DOI is supplied here. The surname appears as Tymvios in this record and Timvios in the 2004 record; same author.
...
- **Caveat:** AUTHOR MISATTRIBUTION IN OUR DOCS. Doc 03 cites 'Patel, M. T. et al. (2018). Ground sculpting to enhance vertical bifacial solar farm output. arXiv:1806.06666'. There is no Patel on the author list: it is Khan, Sakr, Sun, Bermel & Alam. The version of record is Applied Energy 241:592-598 (2019) under a slightly different title, and it supersedes the preprint doc 03 cites.
...
- **Caveat:** No DOI located and the report was not fetched. Bibliographic details inherited from the pvlib documentation and doc 03.
...
- **Caveat:** This is a SECOND, DISTINCT McCree paper. Doc 02 cites the action-spectrum paper and doc 03 cites this one, both as 'McCree (1972)'. Different articles, different DOIs; they must not be merged into one bibliography entry.
...
- **Caveat:** No DOI located; ASHRAE Transactions volumes are not comprehensively deposited in Crossref. The author list here follows the pvlib documentation and is broader than doc 03's 'Perez, R. et al.'.
...
- **Caveat:** Doc 03 lists this with no authors and no DOI. Both are supplied here.
...
- **Caveat:** Doc 04 cites 'Purdue HO-238-B-W' as if it were the same document as HO-238-W. They are different publications with different author lists.
...
- Verification: URL-verified | Access: public-domain, evidence tier **B**
- Backs:
  - OSU Croptime coverage, verbatim: 'Croptime currently hosts 29 vegetable DD models and three summer annual weed models', closing the doc 04 gap 6 / ledger A16 enumeration question
...
- **Caveat:** Licence is CC BY-NC 4.0, not CC BY. Crossref records online publication 2024; docs 04 and 05 date it 2025, matching the volume 7 issue year.
...
- **Caveat:** Doc 04 dates this 2019, matching the volume 68 issue year; Crossref records online publication in 2018.
...
- Verification: Crossref-verified | Access: paywalled, evidence tier **A**
- Backs:
  - the reciprocal-yield competition model that doc 04 misattributed to Holliday
- **Caveat:** Recorded expressly to correct doc 04's misattribution.
...
- **Caveat:** AUTHOR MISMATCH. Both doc 00 section 11 and doc 04 cite this as 'Finch & Collier (2003)'. The paper has three authors: Finch, Billiald & Collier. The citekey is kept for continuity with the decision record, but any rendered reference must list Billiald.
...
- **Caveat:** BAD CITATION IN OUR DOCS. Doc 04 lists 'Holliday, R. (1968). Plant competition and crop yield. Nature 217:289'. No such Holliday paper exists: Nature 217:289-290 (1968), 'Plant Competition and Crop Yield', is by FARAZDAGHI & HARRIS. Holliday's paper is the 1960 Nature 186:22-24 record here. Doc 04 has conflated two different papers by two different author teams.
...
- **Caveat:** Crossref returns NO issued year for this chapter; 2008 is the book year and is not Crossref-confirmed. Doc 04's supporting sources for the sceptical reading (a ResearchGate copy and a WSU Extension fact sheet) are not peer reviewed and were not verified here.
...
- Verification: Crossref-verified | Access: paywalled, evidence tier **A**
- Backs:
  - on-farm replicated evidence for push-pull; the source doc 05 cites only as 'Field Crops Research 106(3)'
...
- **Caveat:** PAGE MISMATCH: doc 02 gives 97-103; Crossref gives 97-104. Same greenhouse-only restriction as Cockshull 1992.
...
- **Caveat:** Doc 04 links this via a ScienceDirect PII (S1161030115300125) that does not correspond to this DOI. The DOI recorded here is the Crossref record for the exact title doc 04 quotes.
...
- **Caveat:** Doc 05 cites 'PMC4416130 (PLOS ONE 2015 root-foraging LER study)'. No PLOS ONE 2015 root-foraging Three Sisters study was located. The root-foraging LER work is the Annals of Botany pair (this record and zhang2014-three-sisters-roots). Doc 05's PMC reference is unresolved and should be corrected.
...
- **Caveat:** PAGE MISMATCH: doc 04 gives 42:65-72; Crossref gives 42:65-68.
...
- **Caveat:** Doc 04 dates this 2011, matching the volume 55 issue year; Crossref records 2010.
...
- **Caveat:** NO DOI. Government dataset; the DOI field on NCEI's own landing page is an unfilled template placeholder. OUR DOCS UNDERSTATE THE PRODUCT: doc 04 section 1.10 says the Normals give dates at the 50, 40, 30, 20 and 10 percent levels. The published product is 10-90% in 10-point steps at six thresholds, not five percentiles at one. US and US-territory stations only: there is no equivalent product for the rest of the world, so any non-US frost percentile the product renders is an Open-Meteo-derived estimate and must be labelled as such. Completeness flags matter: normals are 'standard' above 80% data availability, 'representative' at 10+ years, and 'provisional' where neighbours cannot fill the record. A station-level frost date is not uniformly reliable.
...
- **Caveat:** TITLE MISMATCH: doc 04 gives 'Woody ornamental plant zonation indices of winter hardiness'. The actual part I title is recorded here. Parts II (10.4141/cjps67-064) and III (10.4141/cjps67-065) also exist and part III carries the map.
...
- **Caveat:** DOI SUPPLIED AND CORRECTED. Doc 05 cites 'Armstrong et al. 2021 (Ecology and Society 26(2):6)' with no DOI. The correct DOI is 10.5751/ES-12322-260206. The plausible-looking 10.5751/ES-12160-260206 returns 404 and must not be used.
...
- **Caveat:** YEAR AND VOLUME MISMATCH: doc 05 cites 'Armstrong et al. 2022 (Ecosystems and People 18(1))'. Crossref gives 2023, volume 19. The 2022 inside the DOI string is the acceptance year, not the issue year.
...
- **Caveat:** YEAR MISMATCH: doc 05 dates this 1985. Crossref gives 1984 (Agroforestry Systems 2:73-86). A separate 1985 Food and Nutrition Bulletin version and a 1989 book chapter also exist, which is probably the source of the confusion.
...
- **Caveat:** CITATION MISMATCH. Doc 05 cites 'Gott 1983 (Archaeology in Oceania 18(1))'. No Gott article was found at Archaeology in Oceania 18(1). Gott's murnong paper is normally cited as Australian Aboriginal Studies 1983(2):2-18, which has no DOI. The Crossref-verified Gott record in Archaeology in Oceania is the 1982 root-use paper here. Doc 05's citation is wrong in at least the volume.
...
- **Caveat:** Doc 05 cites the 1991 first edition. The Crossref-registered record is the 2007 reissue.
...
- **Caveat:** Doc 05 cites 'Roupsard et al. 1999 (Functional Ecology 13(4))' with no DOI or title. The DOI is 10.1046/j.1365-2435.1999.00345.x, not the adjacent .00348.x.
...
- **Caveat:** AUTHOR MISATTRIBUTION IN OUR DOCS. Doc 05 cites 'Fabião et al. 2018 (Water 10(4):489)'. Water 10(4):489 is by Simionesei, Ramos, Oliveira, Jongen et al. There is no Fabião on the author list.
...
- **Caveat:** Free of charge despite being a DIN document, so accessLevel is open-access rather than standard-purchase. The 66% / 2.10 m / area-loss figures were carried over from doc 02 and were NOT read out of the standard text; only the bibliographic record and availability were verified.
...
- **Caveat:** URL CORRECTED: doc 02 does not give a Legifrance identifier and the commonly circulated JORFTEXT000049383066 is wrong. The numeric thresholds were carried over from doc 02 and were not read out of the décret text.
...
- Backs:
  ...
  - estimate-only compliance overlay
- **Caveat:** The PDF was confirmed to exist and to be the ministerial decree, but its numeric thresholds were not extracted; they are carried over from doc 02.
...
- Backs:
  ...
  - estimate-only compliance overlay
- **Caveat:** The PDF at this URL serves the AMENDED text (改正 令和7年3月31日, 6農振第2983号, 31 March 2025), so citing it as 'as of 25 March 2024' is inaccurate. Doc 02's amendment reference 6-Nōshin-2983 is correct but it dates it 2025 without noting that the linked text is the amended version.
...
- **Caveat:** Doc 04's FAO land-resources-planning-toolbox URL is a stale stub, not the database. Use the GAEZ URL.
...
|---|---|---|---|---|
| A1 | Dehesa field studies measure light transmission and soil moisture as a function of distance from the oak trunk, reusable as an empirical template for distance-from-panel-edge modelling | doc 00 §12; doc 05 §4.1 | Attributed only to 'Marcos et al., dehesa radiation transmission'. NOT LOCATED. This is called the highest-value analog in the decision record and rests on an unresolvable citation. | Find the actual paper, or drop the distance-from-edge empirical template and model it from geometry alone |
| A2 | Wind reduction percentages under a panel array | doc 02 thin-evidence 7 | Rests on trade-press coverage, not primary papers. No peer-reviewed source located. | A primary micrometeorology paper, or remove the numeric wind modifier and keep only the qualitative rule |
| A3 | Frost protection and dew formation under panels | doc 02 thin-evidence 6; doc 00 §12 rule 3 | Mechanistically plausible, entirely unquantified. No source. | Any field study with quantified frost/dew deltas |
| A4 | VPD and relative-humidity deltas under panels | doc 02 thin-evidence 5 | Directionally consistent across reports but no numbers were extractable from any accessible source. | Extract the numbers from Marrou 2013b full text, which we hold a verified DOI for but did not read |
| A5 | The 'Beck et al. 2012' 50%-shade threshold | doc 04 gap 3 | Cited *within* agrivoltaic reviews. Primary reference NOT LOCATED and may not exist as described. Not to be confused with Beck et al. 2018 Köppen-Geiger, which is verified. | Trace it, or cite Zhang et al. 2025 for the tipping point instead and delete the Beck 2012 attribution |
...
| A10 | Per-crop shade-response functions conditional on climate | doc 04 gap 8 | Do not exist in the literature in usable form. The product ships a two-context hot/arid vs cool/humid approximation that no source supports. | Label the two-context split as a product heuristic, not a finding |
| A11 | Japanese solar-sharing crop science | doc 02 thin-evidence 10 | Nearly absent in English despite a decade of deployment and a legally binding 80% yield rule. Only sekiyama2019-solar-sharing was located. | Japanese-language literature search, or state the gap in the UI wherever the Japan overlay appears |
| A12 | Nagashima 2015/2020 and AIP Conf. Proc. 2361(1):030002 (2021) | doc 05 §3.1 | Neither citation resolves. The AIP volume 2361 record found at Crossref is a different paper (Hudelson & Lieth, article 080001). | Correct or drop; sekiyama2019-solar-sharing already carries the Nagashima attribution |
| A13 | PMC4416130, described as a 'PLOS ONE 2015 root-foraging LER study' | doc 05 Americas source list | No such study located. The root-foraging LER work is Zhang et al. 2014 and Postma & Lynch 2012, both in Annals of Botany. | Replace the PMC reference with the two verified Annals of Botany DOIs |
| A14 | Base temperatures and DLI values sourced from trackgdd.com, hydroponics blogs and ReduSystems | doc 04 gap 9 | Secondary web sources with no provenance. Doc 04 itself flags that every value reaching a hard filter must be traced first. DLI side closed 2026-09-11 (decision record 23): every Tier C figure cites the class methodology, the three Tier A rows cite per-crop trials, and no ECOCROP entry backs a light integral. Base temperatures remain. | Trace each base temperature to a primary or extension source before release; this is a release blocker, not a nice-to-have |
...
| A15 | Soil data sources (SoilGrids, SSURGO) licence terms and resolution | doc 04 gap 5 | Not researched at all. Stage 3 of the recommendation pipeline depends on them. | Do the research before designing stage 3 |
| A16 | OSU Croptime crop and cultivar coverage | doc 04 gap 6 | Not enumerated; the search budget ran out. GDD-based scheduling is designed around it. | Enumerate which vegetables have published GDD models |
...
| B2 | The ~50% shade tipping point; shade-tolerant vs shade-sensitive groupings; their effect sizes and CIs | `zhang2025-tipping-points` | Paywalled to automated fetch when doc 04 was written. Corroborated only from reviews and pv-magazine. Decision 7: must not reach a hard filter. |
...
| B5 | Italy >=70% agricultural area, 2.1 m, 60% producibility ratio | `italy-dm-436-2023` | Official PDF confirmed to exist; thresholds carried over from doc 02, not extracted. |
| B6 | France 90% of a control zone >=5% of area capped at 1 ha, 40% max coverage | `france-decret-2024-318` | Legifrance URL corrected and confirmed; thresholds carried over from doc 02, not extracted. |
...
| B9 | Juglone landscape-scale evidence is weak | `jose-juglone` | The Springer chapter is verified but paywalled. Doc 04's sceptical framing leans on a ResearchGate copy and a WSU Extension fact sheet, neither peer reviewed nor verified. |
| B10 | Light saturation point 25-60% of maximum sunlight at canopy level for C3 crops | Pang et al. 2019 and Carrier et al. 2019 | Cited by doc 02 only as secondary citations *inside* Laub et al. 2022 §4.3. Neither primary paper was located or verified. |
...
6. **Do not verify our numbers against EarthArXiv 7354.** `tekie2024-drought-index-preprint` is a different,
   ...
   most likely way a future reviewer gets this wrong.

### D. Doc 02 thin-evidence areas, mapped to this corpus

| # (doc 02 §7) | Area | Covered by |
|---|---|---|
...
### E. Doc 04 known gaps, mapped to this corpus
...
| 4 | Most DLI values in doc 04 §3.6 are Tier C inferences | **Confirmed and unchanged.** Ordinal ranking reliable, absolutes provisional. Doc 04's own suggested fix (a systematic review of shade-cloth trials, convertible to DLI given site radiation) is the highest-value follow-up and would upgrade 20-30 rows from C to B. |
...
|---|---|---|
| doc 04 §8 | Holliday, R. (1968). Plant competition and crop yield. *Nature* 217:289 | **Nature 217:289-290 (1968) is by Farazdaghi & Harris.** Holliday's paper is *Nature* 186:22-24 (1960). Two different papers conflated. See `holliday1960-population-yield` and `farazdaghi1968-competition-yield`. |
| doc 04 §8 | Luedeling, E. et al. (2011). The Dynamic Model provides the best description of the chill process. *HortScience* 46(3):420-425 | **HortScience 46(3):420-425 is by Zhang & Taylor**, and it is a single-site pistachio study in Australia, not a global comparison. The global-comparison claim belongs to Luedeling & Brown 2010 (`luedeling2010-chill-comparability`). |
| doc 03 §9 | Patel, M. T. et al. (2018). Ground sculpting to enhance vertical bifacial solar farm output. arXiv:1806.06666 | **Authors are Khan, Sakr, Sun, Bermel & Alam.** No Patel. Version of record is *Applied Energy* 241:592-598 (2019), `10.1016/j.apenergy.2019.01.168`. |
| doc 05 Europe | Fabião et al. 2018 (*Water* 10(4):489) | **Water 10(4):489 is by Simionesei, Ramos, Oliveira, Jongen et al.** No Fabião on the author list. |
| doc 03 §9 | INRAE (2023). Assessment of the ground coverage ratio ... hal-04240227 | **Single-authored by Christian Dupraz.** Version of record *Agroforestry Systems* 98:2679-2696 (2024), `10.1007/s10457-023-00906-3`. hal.science blocks automated fetch; use hal.inrae.fr. |
| doc 00 §11, doc 04 §4.5 | Finch & Collier (2003) | **Three authors: Finch, Billiald & Collier.** *Ent. Exp. Appl.* 109:183-195. |
| doc 05 §1.8 | Armstrong et al. 2022 (*Ecosystems and People* 18(1)) | 2023, volume 19. The 2022 inside the DOI is the acceptance year. |
| doc 05 §1.8 | Armstrong et al. 2021 (*Ecology and Society* 26(2):6), no DOI | DOI is `10.5751/ES-12322-260206`. The plausible-looking `10.5751/ES-12160-260206` 404s. |
| doc 05 Africa | Fernandes, O'Kting'ati & Maghembe 1985 (*Agroforestry Systems* 2) | 1984, *Agroforestry Systems* 2:73-86. Separate 1985 and 1989 versions exist elsewhere. |
| doc 05 Asia/Oceania | Gott 1983 (*Archaeology in Oceania* 18(1)) | No Gott article at that location. The murnong paper is *Australian Aboriginal Studies* 1983(2):2-18 (no DOI); the Crossref-verified Gott record in *Archaeology in Oceania* is 1982, 17:59-67. |
| doc 02 §8 | Widmer et al. (2024/2025). Strawberry and raspberry under agrivoltaics: minimum DLI requirements | Title is a paraphrase; four of six given names are wrong; version of record is 2026, *AgriVoltaics Conference Proceedings* 4, `10.52825/agripv.v4i.2837`. |
| doc 02 §8 | Doedt, C., Tajima, M., Iida, T. (2022). Agrivoltaics in Japan: a legal framework analysis | Crossref gives issue year 2024 and the short title 'Agrivoltaics in Japan'. |
| doc 02 §8, §1.2 | McCree (1972). The action spectrum... *Agricultural Meteorology* 9:191-216 | Crossref issued year is 1971. Volume and pages are correct. Separately, doc 03 cites a *different* McCree 1972 paper (*Agric. Meteorol.* 10:443-453) under the same short form; they must not be merged. |
| doc 02 §8 | Marcelis et al. (2006), *Acta Horticulturae* 711:97-103 | Pages 97-104. |
| doc 04 §4.5 | Theunissen (1994), *Pesticide Science* 42:65-72 | Pages 65-68. |
| doc 04 §1.7 | Ouellet & Sherk (1967). Woody ornamental plant zonation indices of winter hardiness | Actual part I title: 'Woody ornamental plant zonation: I. Indices of winterhardiness', *Can. J. Plant Sci.* 47:231-238. Parts II and III also exist; part III carries the map. |
| doc 04 §4.11 | Peng et al., ScienceDirect PII S1161030115300125 | That PII does not correspond to the quoted title. Correct DOI: `10.1016/j.eja.2015.07.007`. |
| doc 02 §8 | Tekie et al. 2024, https://eartharxiv.org/repository/object/7354/ | URL 404s. Working URL is `/repository/view/7354/`; DOI `10.31223/X5KT33`. See section C item 6 for why this preprint is dangerous. |
| doc 05 Americas | PMC4416130 (*PLOS ONE* 2015 root-foraging LER study) | Not located. The root-foraging LER work is Zhang et al. 2014 and Postma & Lynch 2012, both *Annals of Botany*. |
| doc 04 §2 | FAO ECOCROP via the land-resources-planning-toolbox URL | Stale stub. ECOCROP now lives at <https://gaez.fao.org/pages/ecocrop>; `ecocrop.fao.org` is dead. |
| doc 02 §6.5 | Décret n° 2024-318, no Legifrance id | Correct id is JORFTEXT000049386027. The widely circulated JORFTEXT000049383066 is wrong. |
| doc 05 Europe | *Forest Ecology and Management* 2021 (Central European coppice decline) | Ambiguous: two plausible 2021 FEM matches exist (Slach et al. `10.1016/j.foreco.2021.119687` and Johann `10.1016/j.foreco.2021.119129`). Cannot be pinned. |
| doc 04 §8 | Purdue HO-238-B-W treated as interchangeable with HO-238-W | Different publications, different author lists. HO-238-B-W adds Currey and Faust. |
| doc 04 §8 | Virginia Coop. Ext. SPES-720 | Printed publication number is SPES-720NP; author Eric Stallknecht, 2025. |
