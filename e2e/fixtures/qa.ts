...
/**
 * The design as the controls report it. Read off the inputs a grower typed into rather
 * than off any number a run produced, so comparing two of these compares the design
 */
 ...
 * search could separate from its pick; the newcomer audit found a twelve-year-old who never saw
 * that fold and a ten-year-old who met "No panels at all" as the only card. The row of names is
