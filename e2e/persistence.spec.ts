 ...
 * every assertion below is one of two kinds: this survived, or this was worked out again.
 *
 ...
 * that the garden cannot be read without are worked out again by themselves.
 *
 ...
 * that said nothing had been worked out. And the light follows it, since 2026-09-10, the moment
...
test('the design survives a reload while every computed result is worked out again', async ({
  page,
}) => {
