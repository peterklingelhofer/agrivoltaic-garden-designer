...
const needsLight = (state: AppState): AgentReply => {
  ...
  /*
    ...
    that they had not computed any layouts yet, and offered them the search they had already
...
const explain = (state: AppState, slots: Slots): AgentReply => {
  ...
  */
  ...
  /*
    And what the panels cost the harvest, which the seasons step now computes by running the
    same year again with every row pulled off the plot. Asking for this figure used to get
    "nothing recorded" while the app was one press from computing it
  */
  ...
  switch (understanding.intent) {
    ...
    case 'ask-energy': {
      ...
      /*
        ...
        computes it. A grower who had run five seasons asked for a number this held all along,
