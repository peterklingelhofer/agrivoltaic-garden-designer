 ...
 * implementation of the physics at all: `requirePhysicsCore` refuses when none is installed, and
 ...
 * numbers is worse than no numbers, which is the same argument `src/data/http.ts` makes for
 * refusing a read.
 *
