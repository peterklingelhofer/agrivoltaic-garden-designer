 ...
 * the electricity term of a dense array outruns any crop it costs (`docs/GAME-PORT.md` 8g measured
...
export const standingOf = (reports: readonly SeasonReport[]): Standing => {
  ...
  */
  ...
  /*
    Named, numbered and cited, in the voice the owner set for the whole app (`docs/VOICE.md`):
