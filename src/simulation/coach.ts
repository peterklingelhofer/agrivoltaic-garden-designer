...
export const advise = (
  ...
  if (thirsty !== null && thirsty.droughtPenalty > 0.1) {
    return {
      id: 'thirsty',
      /*
        The two totals used to stand alone, and a year with more rain than demand read as a
        contradiction: "ran short of water: 1098 mm of rain against 950 mm" was read three times
        by a Master Gardener. The shortfall is in the daily balance between rains, where the root
        zone holds only so much of a downpour and dries out before the next one
      */
