...
export const simulateSeason = (input: SeasonInput): SeasonResult => {
      ...
      if (violation !== null) {
        outcomes.push(
          outcomeOf(
            ...
            planting,
            'refused',
            // the plain name first and the Latin after it, because a nine-year-old read
            // "Plasmodiophora brassicae (clubroot)" as another language and stopped there
  ...
  /*
    ...
    expensive (`docs/CONVERGENCE.md` 7.1, item 8)
  */
  const harvestIndex =
    outcomes.length === 0
      ? null
