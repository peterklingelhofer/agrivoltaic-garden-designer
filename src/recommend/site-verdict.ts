 ...
 *
 * The app knew both from the moment a place resolved and said neither. The place step showed
 * frost dates, and the climate arrived crop by crop six steps later as a verdict badge beside
 * each row, so nothing said whether the place as a whole was one most of the catalogue could
 * live in. This is that sentence, from the same gate the ranking runs and nothing softer,
