 ...
 * held still. Two reviewers asked for the split on 2026-09-11 after a camera grab reshaped the
 ...
 * simulation pill that used to end the row is gone: "ready" and "loading" beside a title told a
 * phone reviewer nothing, and the step that is waiting now says so in its own status row. The
