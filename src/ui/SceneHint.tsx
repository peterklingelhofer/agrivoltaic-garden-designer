...
const PlantPrompt = (): ReactElement | null => {
  ...
  /*
    ...
    already full of plants read as a way to see them planted, and a twelve-year-old pressed it
    expecting the picture to change, not the plan to open; a bed's plants also could not be read
