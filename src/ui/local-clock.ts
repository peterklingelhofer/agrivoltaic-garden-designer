 ...
 *
 * The store keeps every instant in UTC and the sun is worked out from that, which is right for
 * the physics and was wrong on the screen: an extension educator in Trenton read "Sunrise 09:54
 * UTC" and said it was the one line that would make a room stop trusting everything else. The
