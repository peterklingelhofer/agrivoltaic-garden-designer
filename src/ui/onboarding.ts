 ...
 * 2026-09-17 (the owner's rewrite): what stays is whose rules they are and, in plain words, what
...
// exception request is, in the words that made it make sense to the owner, who had read the bare
 ...
 * quoted. The determination clause came out on 2026-09-17 (the owner's rewrite); the sentence
