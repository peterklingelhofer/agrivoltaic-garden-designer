 ...
 * the layout search on the step after this one and neither needs anything worked out first.
...
/** Everything a row figure is worked out from, read off the store field by field */
...
/**
 * Said under the choice rather than as four figures beside it. An educator read the split
 * before choosing anything and could not tell whether the numbers were his answer or the app's
 * default; a class asked where the other thirty percent had gone when two of the four were
