...
/**
 * Where the solar panels go: the search first, because the layouts it works out are the answer
 ...
 */
/**
 * The two dials a lesson is built on, on the face of the step. Two educators went looking for
 * "change something about the panels and watch the light change" and found it only inside the
...
export const LayoutPanel = (): ReactElement => {
  ...
  return (
    ...
    >
      ...
      >
        {searching ? 'Working out layouts...' : found ? 'Search again' : 'Show me some layouts'}
      </Action>
      {searching ? (
        <>
          <SearchProgress />
