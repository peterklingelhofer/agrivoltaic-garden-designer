...
export interface StepperProps<T extends string> {
   ...
   * foot of the scene: the sidebar had step one expanded underneath it, so a visitor met two
              ...
              >
                ...
                */}
                ...
                {/*
                  ...
                  The reason lived in a hover title and a hidden span, so an eight-year-old saw five
                  padlocks appear and nothing said why; the sentence is the same one the open step
