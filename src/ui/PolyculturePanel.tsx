...
/**
 * The combinations worked out for the selected bed, asked for by an effect and never by a press.
 *
...
export const Combinations = (): ReactElement => {
  ...
  /*
    ...
    beds and the step's Next: a seventy-year-old who was happy with what the app planted gave
    up looking for the way forward before he reached it
  */
  return (
