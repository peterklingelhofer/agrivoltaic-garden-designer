...
/**
 * Both units, the way every size in this app already prints metres and feet. "28 days above
 * 30 °C" on a screen that has already given 9 by 6 metres in feet leaves the one figure a grower
 ...
 *
 * Raise a bed ten centimetres past what a tomato asks for and two faults meet: the ranking
 * never re-runs, which `autoRunKey` now covers, and this sentence had no case for a bed that
 * already fits
 */
