...
export const BedSizeFields = ({ bed }: { readonly bed: Bed }): ReactElement | null => {
  ...
  const [a, b, c] = ring
  // a bed drawn by hand is whatever shape its corners make; a Master Gardener asked why one bed
  // had size fields and another had none, so the answer is printed where the fields would be
