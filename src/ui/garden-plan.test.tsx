...
/**
 * The newcomer audit's defect 2: the panel listed the crops the generation planted while the
 * planting question had since replaced them, so a ten-year-old read the old names for four
 * minutes and believed her choice had failed. The list reads the plot now
 */
