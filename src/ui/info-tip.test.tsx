...
/**
 * The other half of the newcomer audit's defect 14. A pointer press arrives as pointerenter and
 * then click; the enter opened the bubble and the click toggled it shut, so a press never showed a
 * sentence and only a hover did. The fifteen-year-old pressed the ⓘ beside "DLI", watched it turn
 * green and found nothing to read
 */
