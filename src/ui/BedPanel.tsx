...
const PlantingSection = ({
  ...
  */
  ...
  /**
   * The bed the draft is derived against, and what it derives to, worked out against nothing
      ...
      {!rankingReady ? (
        ...
        <>
          {/* the only way into a 163-crop ranking for somebody who came here wanting one plant:
              a ten-year-old scrolled past hops, tomatillo, purslane and phacelia looking for a
              tomato and settled on field pea, because "pea" was a word she knew */}
          <TextField
          ...
          {rootDepthIssue === null || rootDepthIssue.shortfallM <= 0 ? null : raiseToM === null ? (
            ...
            >
              {/* the height the sides stand above the ground, which is what the field on the
                  ground step sets; a Master Gardener read "to 0.50 m" beside "0.95 m deep" as
 ...
 * was the first thing a phone reviewer counted against the step, and the switch is remembered
