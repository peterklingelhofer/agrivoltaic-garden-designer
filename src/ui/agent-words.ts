 ...
 * reader may skim how a thing was worked out and may not skim what it does not cover, and until
...
export const OUT_OF_SCOPE: Readonly<Record<ScopeTopic, string>> = {
  cost: "I have nothing on cost or payback. This works out light, yield and electricity, and it never sees a price. I can tell you the kilowatt hours, and you'd need a tariff to turn that into money.",
  permitting:
  ...
  grid: 'Grid connection, export and storage are outside what this works out. It stops at the electricity the panels would make.',
  structure:
    "How the panels are mounted, founded and installed isn't something this covers. It works out where the shade falls. What holds the frame up is outside it.",
...
export const BLOCKED_TEXT: Readonly<Record<BlockedNeed, string>> = {
  ...
  beds: 'There are no beds to plant yet. I can work out a layout first if you like.',
  /*
  ...
  */
  ...
  /*
    ...
    worked out, and only the ranking that reads it is missing. Saying "running the sun" here would
