 ...
 * cards. A master gardener and the owner both watched it and could not say what it was for
 ...
 * from, which is arithmetic over the answers, so it costs nothing to work out for every option
