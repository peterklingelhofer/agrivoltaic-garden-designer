...
export const GardenPlanPanel = (): ReactElement | null => {
   ...
   * the moment it planted. "Try another mix" replaces what is in a bed, and a ten-year-old who
   * chose one read the old crops here for four minutes and believed her choice had failed
   */
