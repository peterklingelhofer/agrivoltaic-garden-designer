 ...
 * A source jump lands on a row inside that step. Pressing "show this work in Sources" from a
 * tree's card could arrive at the top of the step with the row 28,000 px below: the jump had
 * scrolled first and the landing had dragged the column back. So the jump
