...
/**
 * Works out the light by itself: the first time, and again whenever the garden moves out from
 * under it.
 *
 ...
 * step and a button, and the owner asked why the light did not simply follow the place. It does
 ...
 * (`docs/GAME-PORT.md` section 5), which a debounce spends once per settled edit rather than per
