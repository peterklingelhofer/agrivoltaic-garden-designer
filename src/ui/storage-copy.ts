 ...
 *
 * In their own module rather than beside the component, because both sentences depend on
 ...
 *
 * The raw define rather than the `AGENT_ENABLED` export, for the reason `App.tsx` gives: a const
 ...
 * can undo that. Naming the pieces rather than saying "everything" is deliberate; a grower who
