 ...
 *
 * The plot sizes carried both from the start and the weather never did, so "28 days above
 * 30 °C" sat on a screen that had already given 9 by 6 metres in feet, leaving the one figure a
 * grower gardens by unconverted. The Celsius stays first because every threshold in the
