...
export interface OnboardingAnswers {
   ...
   * plot fits twelve, which a master gardener called "close to a full farm" against the three
   * or four a household tends; the count is the grower's to cap, and the light still says where
   * the beds it keeps go
   */
