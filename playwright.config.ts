 ...
 * nearly all of them timeouts waiting on a predicate, a camera move, or paint stability. The same
 * specs pass on a laptop in seconds.
 *
  ...
  */
  ...
  webServer: {
    /*
      ...
      panel and could catch it disturbing something. The deployed chat answered poorly, so the
      agent is off in production and off in `bun run dev`: the 44 tests in
  ...
  projects: [
     ...
     *
     * Registered behind an env flag, because this
